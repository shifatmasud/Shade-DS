...
- **parasitic-layer-component** (found in `/skills/parasitic-layer-component/SKILL.md`): Activate when creating "self-aware" components that bind directly to parent or sibling DOM nodes to augment UI behavior or rendering (e.g., RippleLayer, StateLayer, SuccessLayer).
